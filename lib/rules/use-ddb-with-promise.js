...
module.exports = {
  ...
  create: function(context) {
    ...
    function findDDBVariableDeclaratorsFromNode() {
    ...
    function findDDBVariableDeclaratorsFromRequireDestructs() {
    ...
    function findDDBReferencesFromDDBRequireDestructs() {
    ...
    return {
      "Program:exit"(node) {
        const references1 = findDDBReferencesFromDDBRequireDestructs();
