  ...
  create: function(context) {
    ...
    return {
      "Program:exit"(node) {
        ...
        const references = references1.concat(references2);
      ...
      VariableDeclaration(node) {
        ...
        const awsVariableNames = awsImportNames.concat(awsRequireNames);
        ...
        declarations.forEach(declaration => {
          if (declaration.id.type == "ObjectPattern") {
            //deconstructed
            const ddbPropertyNode = declaration.id.properties.find(
