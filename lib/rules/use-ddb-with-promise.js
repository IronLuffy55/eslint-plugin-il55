  ...
  create: function(context) {
    ...
    return {
      "Program:exit"(node) {
        ...
        const set1 = findDDBVariableDeclaratorsFromNodes(nodes);
        const set2 = findDDBVariableDeclaratorsFromRequireDestructs(
          ddbRequireDestructs
        );
        const set3 = findDDBVariableDeclaratorsFromDocumentClientDestructs(
          documentClientDestructs
        );
        const set4 = set1.concat(set2).concat(set3);
        const references = findDDBReferencesFromVariableDeclarators(set4);
